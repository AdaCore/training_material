...
package STM32F4.Timers is
   ...
   --  TIM_OCxPreloadConfig: eg TIM_OC1PreloadConfig
   ...
   --  timer.  Used in pre/postconditions.
   ...
   type Timer_Slave_Mode is
     (Disabled,
      Encoder_Mode_1,  -- counter counts up/down on TI2FP2 edge
      Encoder_Mode_2,  -- counter counts up/down on TI1FP1 edge
   ...
   subtype Timer_Encoder_Mode is
     Timer_Slave_Mode range Encoder_Mode_1 .. Encoder_Mode_3;
...
private
   ...
   --  spread across the two words of CCMR1 and CMR2 in the timer
   ...
   type TIMx_CCER is array (Timer_Channel) of Single_CCE
     with Volatile_Components, Component_Size => 4, Size => 16;
