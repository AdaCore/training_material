package Schedule is
   ...
   procedure Add_Class
     (Classes    : in out Classes_T;
      ...
      Start_Time : Time_T;
      End_Time   : Time_T)
   with Pre => Count (Classes) < Maximum_Classes;
...
private
   ...
   function Valid_Times (Class : Class_T) return Boolean
   is (if Class.Day in Short_Class_T
       then Class.End_Time - Class.Start_Time = 1.0
       elsif Class.Day in Long_Class_T
       then Class.End_Time - Class.Start_Time = 1.5
