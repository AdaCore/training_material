...
procedure Main is
   ...
   type Distance_T is (Feet, Meters, Miles);
   pragma Convention (C, Distance_T);
   ...
   pragma Convention (C, Data_T);

   function C_Miles_Per_Hour (Data : Data_T) return Interfaces.C.C_float;
   pragma Import (C, C_Miles_Per_Hour, "miles_per_hour");
   ...
   Object_Miles  : constant Data_T :=
     (Distance => 1.0, Distance_Type => Miles, Seconds => 1.0);
