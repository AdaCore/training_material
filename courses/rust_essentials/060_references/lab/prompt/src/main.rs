...
fn main() {
    ...
    let angle = ReferencesStruct { count: 12, value: 34.5, };
    let ref_angle = &angle;
    *ref_angle.count = *ref_angle.count * 2;
    *ref_angle.value = *ref_angle.value * 2.0;
    println!("{} {}", *ref_angle.count, *ref_angle.value);
    ...
    let bricks = ReferencesStruct { count: 6, value: 78.9, };
    let buildings = ReferencesStruct { count: 1, value: 2.3, };
    let ref_both = &bricks;
    ...
    let cars = ReferencesStruct { count: 67, value: 8.9, };
    let ref_cars = &mut cars;
    let mut ref_cars = &cars;
    ...
    let dog = ReferencesStruct { count: 1, value: 2.3, };
    let duck = ReferencesStruct { count: 4, value: 5.6, };
    let ref_both = &dog;
    println!("{} {}", ref_both.count, ref_both.value);
    ref_both = ReferencesStruct {count: 0, value: 0.0, };
    println!("{} {}", ref_both.count, ref_both.value);
    ref_both = &duck;
    println!("{} {}", ref_both.count, ref_both.value);
    ref_both = ReferencesStruct {count: 0, value: 0.0, };
    ...
    let ref_emu = {
        let first = ReferencesStruct {count: 9, value: 8.7};
        let second = ReferencesStruct {count: first.count + 1, value: first.value - 1.1};
        &second
    };
    ...
    let ref_floats: &[f64] = &floats[0..1];
    println!("{:?}", ref_floats);
    ref_floats[1..3] = &floats[1..3];
    println!("{:?}", ref_floats);
    ref_floats = &floats[2..];
    println!("{:?}", ref_floats);
