...
>
> Update this glossary by using the [reusable update prompt](#reusable-update-prompt) below. Then review the generated diff and verify technical claims against the official Rust sources listed in this document.
...
- the date-based version and change history must be updated together;
...
Version identifiers use `YYYY.MM.DD.NN`, where `NN` is a two-digit revision
...
Removed redundant dates from changelog headings.

Changes included in version 2026.07.23.03:

- simplified each changelog heading from forms such as
  `2026.07.23.02 - 2026-07-23` to `2026.07.23.02`;
- clarified that the revision date is already embedded in the
  `YYYY.MM.DD.NN` identifier;
- updated the reusable maintenance prompt so it requests a new history entry
  without separately requiring a dated heading;
- preserved the chronological order and content of all existing history entries.

### 2026.07.23.02

Restored compatibility with Pandoc's default LaTeX PDF generation.

Changes included in version 2026.07.23.02:

- replaced the Unicode U+26A0 warning symbol in the top maintenance warning with an
  ASCII-only `WARNING:` label;
- preserved the prominence and meaning of the no-manual-edit warning;
- removed the character that caused LaTeX to report that Unicode character U+26A0
  was not set up for use with LaTeX.

### 2026.07.23.01

Replaced semantic versioning with date-based versioning and strengthened the
maintenance warning.

Changes included in version 2026.07.23.01:

- added a prominent warning at the very top of the file stating that the glossary
  should not be edited manually;
- directed maintainers to use the reusable update prompt and then review the
  generated diff;
- replaced the top-level semantic version with the `YYYY.MM.DD.NN` format;
- removed the redundant **Last updated** field;
- updated the reusable prompt, maintenance guidance, and human-review checklist to
  use date-based versioning;
- converted all historical changelog identifiers to the date-based format while
  preserving their original dates and chronological order.

### 2026.07.13.06

Added guidance for AI-assisted glossary maintenance.

Changes included in version 2026.07.13.06:
...
- defined mandatory rules for alphabetical ordering, deduplication, synchronized
  terminology, date-based versioning, and changelog maintenance;
...
Changes included in version 2026.07.13.05:
...
Changes included in version 2026.07.13.04:
...
Structural correction to version 2026.07.13.02.

Changes included in version 2026.07.13.03:
...
Changes included in version 2026.07.13.02:
...
Changes included in version 2026.07.13.01:
