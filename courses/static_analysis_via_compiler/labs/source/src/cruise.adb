package body Cruise is
   ...
   function Control_Braking
     (Front_Braking : Boolean)
      return Braking_Mode is
   begin
      if Front_Braking
      then
         return Hard_Braking;
   ...
   function Control_Speeding
     (Self_Speed     : Speed;
      ...
      return Speeding_Mode is
   begin
      if Front_Distance < Security_Distance (Self_Speed)
      then
         return Speeding;
      else
   ...
   begin
      ...
      then
         ...
         if Time_Collision_Front < Time_Collision_Rear
         then
            return Braking;
         else
            return Speeding;
         end if;
      elsif Time_Collision_Front < 0.0
      then
