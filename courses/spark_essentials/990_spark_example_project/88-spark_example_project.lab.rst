...
* As a full-scale example, you will take the given Ada package and convert it to SPARK
   ...
   - Pre/Post conditions are most important, but you can add :ada:`Depends` contracts as well
...
* Start with the simpler functions first
   ...
   - :ada:`function "*"` is probably the simplest, followed by :ada:`Head` and :ada:`Tail`
