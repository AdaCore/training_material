...
package Unbounded_Sequential_Stacks is
   ...
   procedure Push (Onto : in out Stack; Item : Element);
   ...
   --  Provides access to the top element in the stack (the last element
   --  pushed) without requiring that element to be first removed from the
   --  stack
